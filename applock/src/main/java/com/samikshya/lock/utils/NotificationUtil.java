package com.samikshya.lock.utils;
...
public class NotificationUtil {
    ...
    public static void createNotification(Service mContext,String title, String message) {
        ...
        PendingIntent resultPendingIntent = PendingIntent.getActivity(mContext, 112 /* Request code */, resultIntent, PendingIntent.FLAG_IMMUTABLE | PendingIntent.FLAG_UPDATE_CURRENT);
